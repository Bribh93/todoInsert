...
const DashboardCard = () => {
  return (
    <section className="grid grid-cols-1 md:grid-cols-3 md:gap-6 px-10 md:w-[70%] mx-auto my-10 page-transition space-y-6 md:space-y-0">
      ...
      <Link to={"/supabasepage"} className="py-14 flex justify-center items-center  rounded-4xl text-4xl bg-green-700 shadow-green-600 shadow-lg hover:scale-105 relative transition-transform duration-300 ">
        Supabase
      </Link>
