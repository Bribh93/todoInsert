  ...
  return (
    <div className="grid justify-center items-center max-w-2xl mx-auto">
      ...
      >
        ...
        <button
          type="submit"
          className="w-[50%] bg-transparent border-2 border-yellow-500/50 text-yellow-500 py-2 px-5 rounded-full hover:bg-yellow-500 hover:text-white transition-colors"
        >
          Add
        </button>
      </form>
